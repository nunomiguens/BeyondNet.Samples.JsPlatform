...
describe('UTIL - HELPER - ResultHelper', () => {
    const buildInstance = () => result_helper_1.ResultHelper.Instance();
    const payload = 'foo';
    const buildDataModel = (code, name) => new models_1.ResultModel(models_1.ResultTypes.Data, code, name, payload);
    const buildErrorModel = (code, name) => new models_1.ResultModel(models_1.ResultTypes.Error, code, name, payload);
...
//# sourceMappingURL=result-helper.test.js.map
