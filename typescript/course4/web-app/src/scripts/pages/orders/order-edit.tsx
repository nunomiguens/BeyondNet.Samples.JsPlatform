                    ...
                    <ControlForm onSubmit={() => this.onSubmit()}>
                        ...
                        <ControlGroup>
                            ...
                            <TextInput
                                ...
                                onChange={(address1) => this.setState({ address1: address1 || "" })} />
                        </ControlGroup>
                        <ControlGroup>
                            ...
                            <TextInput
                                ...
                                onChange={(address2) => this.setState({ address2: address2 || "" })} />
                        </ControlGroup>
                        <ControlGroup>
                            ...
                            <TextInput
                                id="city"
                                placeholder="Name"
                                value={this.state.city} onChange={(city) => this.setState({ city: city || "" })} />
                        </ControlGroup>
                        <ControlGroup>
                        ...
                        <ControlGroup>
                            ...
                            <SelectInput
                                ...
                                onChange={(priority) => this.setState({ priority: NumberHelper.parseString(priority) })} />
                        </ControlGroup>
                        <h2>Food Items</h2>
                        <div className="row">
                        ...
                        <div className="row total-price-row text-right">
                            <strong className="total-price">
                                {NumberHelper.formatAsCurrency(this.state.foodItems.map(f => f.price).filter(price => price != null).reduce((a, b) => a! + b!, 0))}
                            </strong>
                        </div>
            ...
            return (
                <div className="inline-elements">
                    <SelectInput
                        ...
                        options={options}
                        onChange={(addFoodItemID) => this.setState({ addFoodItemID: addFoodItemID })} />
